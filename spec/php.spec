...
Group: Development/Languages
Requires: php-common = %{version}-%{release}, sqlite >= 3.6.0
...
# Comment safe_mode directive to avoid E_DEPRECATED error
/bin/sed -i 's/^[ \t]*safe_mode[ \t]*\=/;&/i' /etc/php.ini
...
function webserver() {
        ...
        case $ACTION in
                restart)
			# If php.disable_webserver_restart file doesn't exist restart Apache gracefully
