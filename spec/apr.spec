...
# Security fixes
Patch20: apr-1.2.7-CVE-2009-2412.patch
...
Summary: Documentation for the Apache Portable Runtime library
...
%changelog
* Wed Aug  5 2009 Joe Orton <jorton@redhat.com> 1.2.7-11.1
- add security fix for CVE-2009-2412 (#515709)

* Wed Jan 17 2007 Deepak Bhole <dbhole@redhat.com> 1.2.7-11
- Resolves: bz222714. Moved the documentation to a -docs subpackage.
